...
export default function TeacherNewsPage() {
  ...
  useEffect(() => {
    fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL || 'http://localhost:3005'}/api/news`)
      .then((res) => res.json())
      .then((data) => {
        setNews(data);
        setLoading(false);
        ...
        {news.map((item) => (
          ...
          >
            ...
            <div className="p-6 flex-1 flex flex-col">
              ...
              <h3 className="text-xl font-bold text-slate-800 line-clamp-2 group-hover:text-amber-600 transition-colors mb-4">
                {item.title}
              </h3>
              <div className="mt-auto pt-4 border-t border-slate-50 flex items-center text-amber-600 font-bold text-sm">
                Подробнее
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-300">
          <div className="bg-white rounded-3xl max-w-4xl w-full max-h-[90vh] overflow-hidden shadow-2xl flex flex-col animate-in zoom-in-95 duration-300">
            ...
            <div className="p-8 overflow-y-auto">
              ...
              <div className="flex items-center text-sm text-amber-600 font-bold mb-4 uppercase tracking-wider">
