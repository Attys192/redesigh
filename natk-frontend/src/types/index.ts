...
import type {
  ...
  IAdmissionCampaign as SharedIAdmissionCampaign,
  IAdmissionPlan as SharedIAdmissionPlan,
  IAdmissionResult as SharedIAdmissionResult,
  ISpecialtyProfile as SharedISpecialtyProfile,
...
export type {
  ...
  SharedIAdmissionCampaign as IAdmissionCampaign,
  SharedIAdmissionPlan as IAdmissionPlan,
  SharedIAdmissionResult as IAdmissionResult,
  SharedISpecialtyProfile as ISpecialtyProfile,
...
export interface IScheduleFrontend extends Omit<SharedISchedule, 'lessonDate'> {
  lessonDate: Date;
}

export interface INewsFrontend extends Omit<SharedINews, 'publishedDate'> {
  publishedDate?: Date;
}
